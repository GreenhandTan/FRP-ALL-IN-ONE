...
const translations = {
  zh: {
    ...
    dashboard: {
      ...
      tunnels: {
        ...
        remotePort: "远程端口",
        remotePortSuggest:
          "建议使用私有端口范围 49152-65535，可减少端口冲突风险",
        remotePortNonPrivate:
          "当前端口不在 49152-65535 私有端口范围内，请确认端口未被占用且已放行",
        status: "状态",
        active: "运行中",
        inactive: "已停止",
        actions: "操作",
  ...
  en: {
    ...
    setup: {
      ...
      clientScriptHint:
        "Run this script with root privileges on your intranet machine",
    ...
    dashboard: {
      ...
      tunnels: {
        ...
        remotePortSuggest:
          "Recommended private port range: 49152-65535 (lower collision risk)",
        remotePortNonPrivate:
          "This port is outside 49152-65535. Ensure it is free and allowed by firewall/security group.",
        status: "Status",
        active: "Active",
        inactive: "Inactive",
        actions: "Actions",
